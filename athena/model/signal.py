...
class AthenaTrainer:
    ...
    def _model_params(self) -> Dict:
        ...
        overrides = dict(self.config.get("training", {}).get("model_params", {}))
        if "feature_fraction" in overrides and "colsample_bytree" not in overrides:
            overrides["colsample_bytree"] = overrides.pop("feature_fraction")
        if "bagging_fraction" in overrides and "subsample" not in overrides:
            overrides["subsample"] = overrides.pop("bagging_fraction")
